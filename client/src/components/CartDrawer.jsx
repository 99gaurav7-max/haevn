                  ...
                  {cart.length === 0 ? (
                    ...
                    cart.map((item, index) => (
                      <motion.div
                        ...
                        className="flex gap-4 p-4 bg-white border border-navy-500/10 card-hover"
                      >
                        <div className="w-20 h-24 flex-shrink-0 bg-warm-200 flex items-center justify-center overflow-hidden">
